...
export default {
    ...
    onLoad(query){
        console.log(query)
        this.num = query.expressageNum;
        this.company = query.expressCode;
        let data = {
            expressageNum:query.expressageNum,
            expressCode:query.expressCode
        }
        wxRequest('/miniProgram/api/trophy/queryExpressTraceByCodeAndNo',{data}).then(res => {
            console.log(res)
